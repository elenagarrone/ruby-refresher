...
def select_elements_starting_with_vowel(array)
	array.reject {|element| !['a', 'e', 'i', 'o', 'u'].include?(element[0])}
end
...
def remove_nils_and_false_from_array(array)
	# array.each {|element| array.delete(element) if element == (nil || false)}
...
def separate_array_into_even_and_odd_numbers(array)
	even_array = array.each.select {|number| number.even?}
	odd_array = array.each.select {|number| number.odd?}
